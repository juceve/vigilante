                        ...
                        <tbody>
                            @foreach ($turnos as $turno)
                                <tr>
                                    ...
                                    <td>{{ $turno->horafin }}</td>
                                    <td align="right">
                                        <a href="{{route('puntoscontrol',$turno->id)}}" class="btn btn-outline-success btn-sm" title="Puntos de Control"><i class="fas fa-map-marked-alt"></i></a>
                                        <button class="btn btn-sm btn-outline-danger"
                                            onclick="eliminar({{ $turno->id }})" title="Eliminar de la DB"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
                            @endforeach
