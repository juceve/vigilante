...
<head>
    ...
    <style>
        body {
            ...
            background-image: url("{{ $datos1[0] ? ($citecotizacion['estado'] ? asset('images/blackbird1.png') : asset('images/anulado.png')) : asset('images/copia.jpg') }}");
...
<body>
    ...
    <div class="contenido">
        ...
        <p style="margin-left: 3rem;margin-right: 3rem; margin-top: 2rem;text-align: justify;">
            <b>BLACK BIRD</b>, cuenta con entrenadores experimentados y la interacción, es permanente, propiciándose el
