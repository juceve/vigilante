    ...
    @if (count($datos))
        <style>
            body {
                ...
                background-image: url("{{ $datos1[0] ? ($citeinforme['estado'] ? asset('images/blackbird1.png') : asset('images/anulado.png')) : asset('images/copia.jpg') }}");
